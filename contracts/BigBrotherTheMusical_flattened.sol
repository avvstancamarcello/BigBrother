...
This standard defines a way to retrieve royalty payment information for a given token.
...
@dev Returns the royalty information for a given token.

Returns the receiver and royalty amount for a given tokenId and salePrice.
*/
...
// File contracts/BigBrotherTheMusical.sol
